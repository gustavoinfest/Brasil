...
export const PREDEFINED_INDICATORS = [
  ...
  { id: 'esb_tratamento_concluido', name: 'Tratamentos Concluidos', group: 'eSB', match: 'Tratamentos Concluidos' },
  { id: 'esb_endodontia', name: 'Taxas de Endontia', group: 'eSB', match: 'Endo' },
