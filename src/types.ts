...
export const PREDEFINED_INDICATORS = [
  ...
  { id: 'esb_tratamento_concluido', name: 'Tratamento Concluído', group: 'eSB', match: 'Tratamento Odontológico Concluído' },
  { id: 'esb_endodontia', name: 'Taxas de Endontia', group: 'eSB', match: 'Taxas de Endontia' },
